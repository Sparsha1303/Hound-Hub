...
const GetServiceIntentHandler = {
    canHandle(handlerInput) {
         return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest' 
          && Alexa.getIntentName(handlerInput.requestEnvelope) === 'GetService';
    },
    handle(handlerInput) {
...
const GetPriceIntentHandler = {
    ...
    async handle(handlerInput) {
        ...
        serviceDetail = helper.getSpokenWords(handlerInput, "serviceDetail");
        resolvedType = helper.getResolvedWords(handlerInput, "serviceDetail");
        if (resolvedType){
